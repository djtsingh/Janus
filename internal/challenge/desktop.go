...
// GenerateChallenge creates a new PoR challenge
func GenerateChallenge(cfg *config.JanusConfig) (*types.Challenge, string) {
...
// VerifyChallenge checks the client's proof
func VerifyChallenge(proof, expectedHash string) bool {
